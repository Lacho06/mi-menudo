import { ROUTE_DEPARTMENT_URL, ROUTE_OCCUPATION_URL, ROUTE_WORKERS_TEMPLATE_URL } from '../../constants/routes/routes';
            ...
            <main className='grid grid-cols-12'>
                ...
                <section className='col-span-12 md:col-span-10'>
                    ...
                    <section className='mx-3'>
                        ...
                        <Table title='Direccion General' heads={ tableHeads } cells={ tableCells } className='my-5' withPlugins withTotals></Table>
                        <Table title='Grupo de gestion' heads={ tableHeads } cells={ tableCells } className='my-5' withTotals></Table>
                    </section>
                </section>
            </main>
        </>
